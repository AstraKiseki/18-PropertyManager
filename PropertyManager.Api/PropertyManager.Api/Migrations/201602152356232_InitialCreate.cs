namespace PropertyManager.Api.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Leases", "User_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.WorkOrders", "TenantId", "dbo.Tenants");
            DropForeignKey("dbo.WorkOrders", "User_Id", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.WorkOrders", new[] { "User_Id" });
            ...
            DropIndex("dbo.Leases", new[] { "User_Id" });
